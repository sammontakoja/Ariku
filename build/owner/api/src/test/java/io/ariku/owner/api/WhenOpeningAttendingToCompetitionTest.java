...
public class WhenOpeningAttendingToCompetitionTest {
    ...
    public void non_authorized_owner_cannot_open_attending_to_competition() {
        ...
        verify(ownerService.attendingDatabase, never()).openAttending(eq(request.userId), eq(request.competitionId));
    }
    ...
    public void authorized_owner_can_open_attending_to_competition() {
        ...
        verify(ownerService.attendingDatabase, atLeastOnce()).openAttending(eq(request.userId), eq(request.competitionId));
    }
